...
def display_movies_type(menu_params, view):
    ...
    add_menu_directory_item(('{}{} ' + get_filtered_items_count_text()).format(view_name, translate_string(30349)), url)
    ...
    path = get_jellyfin_url("/Users/{userid}/Items", params)
    url = sys.argv[0] + "?url=" + quote(path) + "&mode=GET_CONTENT&media_type=movies&sort=none"
    add_menu_directory_item(('{}{}' + get_filtered_items_count_text()).format(view_name, translate_string(30267)), url)
    ...
    path = get_jellyfin_url("/Users/{userid}/Items", params)
    url = sys.argv[0] + "?url=" + quote(path) + "&mode=GET_CONTENT&media_type=movies&sort=none"
    add_menu_directory_item(('{}{} ' + get_filtered_items_count_text()).format(view_name, translate_string(30268)), url)
