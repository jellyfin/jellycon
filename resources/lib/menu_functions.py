...
def showWidgets():
    ...
    url = "{server}/emby/Movies/Recommendations?userId={userid}&categoryLimit=1&ItemLimit={ItemLimit}&format=json&ImageTypeLimit=1&IsMissing=False"
    addMenuDirectoryItem("Recommendations",
